...
int main(int argc, char *argv[])
{
    ...
    groundShader.use();
    groundShader.setFloat("light.constant", 1.0f);
    groundShader.setFloat("light.linear", 0.09f);
    groundShader.setFloat("light.quadratic", 0.032f);
    groundShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
    groundShader.setVec3("light.diffuse", 0.5f, 0.5f, 0.5f); // 将光照调暗了一些以搭配场景
    groundShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
    groundShader.setFloat("ambientStrength", 1.0);
